...
ifdef::backend-html5[]
NOTE: This documentation is also available as https://docs.spring.io/spring-session-data-geode/docs/{spring-session-data-geode-version}/reference/pdf/spring-session-data-geode-reference.pdf[PDF].
endif::[]

ifdef::backend-pdf[]
NOTE: This documentation is also available as https://docs.spring.io/spring-session-data-geode/docs/{spring-session-data-geode-version}/reference/html5/index.html[HTML].
endif::[]
