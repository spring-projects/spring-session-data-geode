...
https://docs.spring.io/autorepo/docs/spring-session-data-geode-build/2.0.6.RELEASE/reference/html5/[here]
and Javadoc is available https://docs.spring.io/autorepo/docs/spring-session-data-geode-build/2.0.6.RELEASE/api/[here].
